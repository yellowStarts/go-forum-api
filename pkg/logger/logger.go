...
func getEncoder() zapcore.Encoder {
	...
	encoderConfig := zapcore.EncoderConfig{
		...
		EncodeTime:     customTimeEncoder,              // 时间格式，我们自动为 2006-01-02 15:04:05
...
// getLogWriter 日志记录介质。huango 中使用了两种介质，os.Stdout 和 文件
...
// 调用示例：
// 		logger.DebugJson("SMS", "短信内容", string(result.RawResponse))
